const struct Evolution gEvolutionTable[NUM_SPECIES][EVOS_PER_MON] =
{
    ...
    [SPECIES_EKANS]      = {{EVO_LEVEL, 22, SPECIES_SEVIPER}},
    [SPECIES_SEVIPER]    = {{EVO_LEVEL, 44, SPECIES_ARBOK}},
    ...
    [SPECIES_POLIWHIRL]  = {{EVO_ITEM, ITEM_WATER_STONE, SPECIES_POLIWRATH},
                            {EVO_LVL_KINGS_ROCK, 1, SPECIES_POLITOED}},
    ...
    [SPECIES_SLOWPOKE]   = {{EVO_LVL_KR_D_GE_SD, 37, SPECIES_SLOWBRO},
                            {EVO_LVL_KR_D_LT_SD, 37, SPECIES_SLOWKING}},
    ...
    [SPECIES_ONIX]       = {{EVO_LVL_METAL_COAT, 30, SPECIES_STEELIX}},
    ...
    [SPECIES_MAROWAK]     = {{EVO_LEVEL, 50, SPECIES_KANGASKHAN}},
    ...
    [SPECIES_SEADRA]     = {{EVO_LVL_DRAGON_SCALE, 30, SPECIES_KINGDRA}},
    [SPECIES_GOLDEEN]    = {{EVO_LEVEL, 33, SPECIES_SEAKING}},
    [SPECIES_STARYU]     = {{EVO_ITEM, ITEM_WATER_STONE, SPECIES_STARMIE}},
    [SPECIES_SCYTHER]    = {{EVO_LVL_METAL_COAT, 30, SPECIES_SCIZOR}},
    [SPECIES_MAGIKARP]   = {{EVO_LEVEL, 20, SPECIES_GYARADOS},
                            {EVO_LVL_KINGS_ROCK, 20, SPECIES_RELICANTH}},
    [SPECIES_EEVEE]      = {{EVO_ITEM, ITEM_THUNDER_STONE, SPECIES_JOLTEON},
                            {EVO_ITEM, ITEM_WATER_STONE, SPECIES_VAPOREON},
                            {EVO_ITEM, ITEM_FIRE_STONE, SPECIES_FLAREON},
                            {EVO_FRIENDSHIP_DAY, 0, SPECIES_ESPEON},
                            {EVO_FRIENDSHIP_NIGHT, 0, SPECIES_UMBREON}},
    [SPECIES_PORYGON]    = {{EVO_LVL_UP_GRADE, 30, SPECIES_PORYGON2}},
    ...
    [SPECIES_CLAMPERL]   = {{EVO_LVL_DS_TOOTH, 30, SPECIES_HUNTAIL},
                            {EVO_LVL_DS_SCALE, 30, SPECIES_GOREBYSS}},
